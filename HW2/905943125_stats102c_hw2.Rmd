...
(a) Propose an envelope distribution and write R code using the acceptance-reject method to
...
(a) Design an algorithm to generate 10,000 random variables using the inverse CDF method and
implement it in R.
